package com.touchstone.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addUsers(MongoTemplate mongoTemplate) {
        ...
        anonymousUser.setUserId("user-1");
